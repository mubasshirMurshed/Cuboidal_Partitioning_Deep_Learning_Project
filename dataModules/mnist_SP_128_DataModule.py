...
class MNIST_SP_128_DataModule(DataModule):
    """
    ...
    def setup(self):
        ...
        """
        self.train_set = MNISTGraphDataset_V4(root="data/mnistExperiment", mode="SP", partition_limit=128, length=None, name="mnistTrain")

        self.val_set = MNISTGraphDataset_V4(root="data/mnistExperiment", mode="SP", partition_limit=128, length=None, name="mnistTest")