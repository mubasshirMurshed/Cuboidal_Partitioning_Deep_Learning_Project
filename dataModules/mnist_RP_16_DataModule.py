...
class MNIST_RP_16_DataModule(DataModule):
    """
    ...
    def setup(self):
        ...
        """
        self.train_set = MNISTGraphDataset_V4(root="data/mnistRP16", mode="RP", partition_limit=16, length=None, name="mnistTrain")

        self.val_set = MNISTGraphDataset_V4(root="data/mnistRP16", mode="RP", partition_limit=16, length=None, name="mnistTest")