...
class MNIST_CP_64_Pure_DataModule_Old(DataModule):
    """
    ...
    def setup(self):
        ...
        """
        self.train_set = MNISTGraphDataset_V4(root="data/mnist64", mode="CP", partition_limit=64, length=None, name="mnistTrain2")

        self.val_set = MNISTGraphDataset_V4(root="data/mnist64", mode="CP", partition_limit=64, length=None, name="mnistTest2")