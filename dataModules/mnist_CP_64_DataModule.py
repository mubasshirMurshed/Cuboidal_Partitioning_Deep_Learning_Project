...
class MNIST_CP_64_DataModule(DataModule):
    """
    ...
    def setup(self):
        ...
        """
        self.train_set = MNISTGraphDataset_V4(root="data/mnistExperiment", mode="CP", partition_limit=64, length=None, name="mnistTrain")

        self.val_set = MNISTGraphDataset_V4(root="data/mnistExperiment", mode="CP", partition_limit=64, length=None, name="mnistTest")