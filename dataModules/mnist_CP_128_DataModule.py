...
class MNIST_CP_128_DataModule(DataModule):
    """
    ...
    def setup(self):
        ...
        """
        self.train_set = MNISTGraphDataset_V4(root="data/mnistExperiment", mode="CP", partition_limit=128, length=None, name="mnistTrain")

        self.val_set = MNISTGraphDataset_V4(root="data/mnistExperiment", mode="CP", partition_limit=128, length=None, name="mnistTest")