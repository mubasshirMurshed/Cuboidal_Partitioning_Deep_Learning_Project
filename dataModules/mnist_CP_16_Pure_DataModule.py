...
class MNIST_CP_16_Pure_DataModule(DataModule):
    """
    ...
    def setup(self):
        ...
        """
        self.train_set = MNISTGraphDataset_V4(root="data/mnist16", mode="CP", partition_limit=16, length=None, name="mnistTrain2")

        self.val_set = MNISTGraphDataset_V4(root="data/mnist16", mode="CP", partition_limit=16, length=None, name="mnistTest2")