...
resume_from_ckpt=r"saved\MNIST_CP_64_Pure_DataModule\MNIST_GAT\Run_ID__2023-02-14__12-10-34\checkpoints\epoch=10-val_loss=0.0638-val_acc=0.9844.pt"
num_classes = 10
...
running_loss = 0
acc1 = MulticlassAccuracy(num_classes, 1, "weighted")
acc2 = MulticlassAccuracy(num_classes, 2, "weighted")
acc3 = MulticlassAccuracy(num_classes, 3, "weighted")
acc4 = MulticlassAccuracy(num_classes, 4, "weighted")
acc5 = MulticlassAccuracy(num_classes, 5, "weighted")
